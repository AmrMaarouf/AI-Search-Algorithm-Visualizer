...
def print_results_table(results):
    ...
    for name, s in results.items():
        print(f"{name:10} | {s['time']:.6f} | {s['nodes_expanded']:8} | {s['path_length']:7} | {s['cost']:6}")'''

# ===============================================================
# DFS SEARCH (REAL IMPLEMENTATION)
# ===============================================================
    ...
    while stack:
        ...
        for d, (dx, dy) in DIRECTIONS.items():
            ...
            if 0 <= nx < global_w and 0 <= ny < global_h:
                if not maze[(x, y)][d] and (nx, ny) not in visited:
                    visited[(nx, ny)] = node
                    stack.append((nx, ny))
...
>>> """
    ...
    while True:
        ...
        print("Path length:", stats["path_length"])
